  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="flex flex-col w-[400px] border-[1px] items-center p-4">
      ...
      <section className="flex flex-col gap-2">
        <input className="outline-none p-2 border-2 text-sm w-[300px]" type="text" name="username" placeholder="Telefono, usuario o correo electronico" />
        <input className="outline-none p-2 border-2 text-sm w-[300px]" type="password" name="password" placeholder="Contraseña" />
        <button type="submit" className="border-2 bg-sky-400 rounded-lg text-white p-2">Entrar</button>
        <hr />
        <a href="" className="text-blue-900 text-center text-xs">Has olvidado la contraseña?</a>
      </section>
    </form>
